...
description:
  ...
  up-to-date, context-aware documentation access for coding agents and developers"
...
summary: >
  ...
  references. It acts as a librarian subagent, intelligently searching
  through repositories and documentation sites to gather relevant context before
...
In [OpenCode](/tools/opencode-flexible-ai-coding-platform/), Context7 serves as the documentation research component. When OpenCode encounters unfamiliar libraries or needs current API information, it leverages Context7 to:
