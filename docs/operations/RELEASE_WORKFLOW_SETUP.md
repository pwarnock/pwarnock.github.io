...
This document explains how to configure and use the self-enforcing release process for v0.21.0+.

The release process consists of two components:
1. **Local Client**: `scripts/release.sh` - creates release requests
2. **CI Controller**: `.github/workflows/release-controller.yml` - processes releases automatically

## GitHub Actions Variables Setup

Before using the release workflow, configure these repository variables in GitHub:
...
- **Used By**: `.github/workflows/release-controller.yml` (version & status commits)
...
1. **Navigate to Repository Settings**
   - Go to: https://github.com/pwarnock/pwarnock.github.io/settings/variables/actions
