...
##############################################################################
# Development Cycle Start Script
# Adds suffix to hugo.toml version for development cycle identification
# Usage: ./scripts/dev-cycle-start.sh [suffix]
##############################################################################
...
echo "   3. When ready for release: ./scripts/release-prep.sh"