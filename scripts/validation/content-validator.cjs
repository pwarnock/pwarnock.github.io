...
Usage: node content-validator.cjs [options]
...
Examples:
  node content-validator.cjs
  node content-validator.cjs --directory content/blog
  node content-validator.cjs --directory content/blog --output validation-report.json
        `);
        process.exit(0);
    }
  }
