...
v0.13.4) with the latest version implementing radar metadata structure for tools
content, about page enhancements, and performance optimizations. The site is now
stable with comprehensive design system, automated release processes, and
enhanced content management. Production is currently running v0.13.4 (faf6a8e).
...
- Add radar metadata structure to tools content for future ThoughtWorks BYOR
  integration
- Enhance about page content and SEO optimization
...
- Radar metadata structure for tools content
- Enhanced about page with improved SEO and messaging
...
- About page content is optimized for SEO and recruiting
